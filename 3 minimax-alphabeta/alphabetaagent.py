...
class AlphaBetaAgent:
    ...
    def decide(self, connect4):
        ...
        for i, drop in moves:
            ...
            score = self.minmax(new_state, False, self.search_depth, -100, 100)
    ...
    def minmax(self, connect4, maximize, depth, alpha, beta):
        if connect4.game_over or depth == 0:
            ...
            for move in connect4.possible_drops():
                ...
                res = self.minmax(new_state, not maximize, depth - 1, alpha, beta)
                results.append(res)
